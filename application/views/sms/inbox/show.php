...
<script type="text/javascript">
	...
	function btn_del(id){
		$("#popup1").hide();
		$("#popup_content_del").html("<div style='padding:5px'><br><div style='text-align:center'>Hapus Data?<br><br><input class='btn btn-danger' style='width:100px' type='button' value='Delete' onClick='del_inbox("+id+")'>&nbsp;&nbsp;<input class='btn btn-success' style='width:100px' type='button' value='Batal' onClick='close_popup_del()'></div></div>");
          $("#popup_del").jqxWindow({
            theme: theme, resizable: false,
            width: 250,
            height: 150,
	...
	$("#popup1").jqxWindow({
	   ...
	   var source = {
			...
			{ name: 'ReceivingDateTime', type: 'string'},
		...
		$("#jqxgrid").jqxGrid(
		{
			...
			columns: [
				{ text: 'Pengirim', align: 'center', cellsalign: 'center', datafield: 'SenderNumber', columntype: 'textbox', filtertype: 'textbox', width: '28%' },
				{ text: 'Isi Pesan', datafield: 'TextDecoded', columntype: 'textbox', filtertype: 'textbox', width: '45%' },
				{ text: 'Diterima', align: 'center', cellsalign: 'center', datafield: 'ReceivingDateTime', columntype: 'date', filtertype: 'none', width: '27%', cellsrenderer: function (row) {
							var dataRecord = $("#jqxgrid").jqxGrid('getrowdata', row);
							return "<div style='width:100%;padding:14px;text-align:center'>"+dataRecord.ReceivingDateTime+"<br>Processed: <b>"+dataRecord.Processed+"</b></div>";
						}
				}
            ]
		});
